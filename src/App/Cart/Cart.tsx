...
import {setItemsOrderToArrayAC} from "../../redux/orders/orders-reducer";
...
const Cart = (props: IProps) => {
    ...
    const orders = useSelector<any>(state => state.orders.order)
    // @ts-ignore
    console.log(`OrdersList: ${orders[0]}`)
    ...
    const handleAddOrder = () => {
        ...
        dispatch(setItemsOrderToArrayAC(props.cartItems))
    };
